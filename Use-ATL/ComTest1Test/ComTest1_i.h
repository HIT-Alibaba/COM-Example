...
#ifndef __ComTest1_i_h__
#define __ComTest1_i_h__
...
EXTERN_C const IID IID_IMyClass;
    ...
    MIDL_INTERFACE("B4D46A93-FF10-46D8-87D3-8E681E70CB80")
    IMyClass : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE IsValidNum( 
            /* [in] */ CHAR *str,
            /* [out] */ BYTE *result) = 0;
    ...
    typedef struct IMyClassVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *IsValidNum )( 
            IMyClass * This,
            /* [in] */ CHAR *str,
            /* [out] */ BYTE *result);
...
#define IMyClass_IsValidNum(This,str,result)	\
    ( (This)->lpVtbl -> IsValidNum(This,str,result) ) 
...
#ifndef __ComTest1Lib_LIBRARY_DEFINED__
#define __ComTest1Lib_LIBRARY_DEFINED__

/* library ComTest1Lib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ComTest1Lib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("879ADCC7-9EDE-48B1-A244-C268DBBEB998")
CompReg;
#endif
...
class DECLSPEC_UUID("C705079D-5C40-4508-9A3F-0F17C21BD3BE")
MyClass;
#endif
#endif /* __ComTest1Lib_LIBRARY_DEFINED__ */
